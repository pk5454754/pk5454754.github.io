...
        BeanSortUtil.sortList(list, sortColumn, FAST);
        return list;
    }
    
    /**
...
        }
        if(FAST.equals(type)){
            BeanSortUtil.sortByFast(methodList,methodSortType,list);
...
     * @param list
     */
    private static void sortByFast(List<Method> methodList,List<Boolean> methodSortType,List list) {
        for (int i = 0; i < methodList.size(); i++) {
            Method tMethod = methodList.get(i);
...
            return true;
        }else if(compareResult<0&&!methodSortType){
            return true;
        }
        return false;
    }
...
            return 0;
        }
        if ("java.lang.String".equals(a.getClass().getName())) {
...
                return 0;
            }
        } else if ("java.lang.Integer".equals(a.getClass().getName())) {
...
                return 0;
            }
        }else if ("java.util.Date".equals(a.getClass().getName())) {
            Date a1 = (Date) a;
            Date b1 = (Date) b;
            if (a1.after(b1) ) {
                return 1;
...
                return 0;
            }
        }else if ("java.lang.Boolean".equals(a.getClass().getName())) {
